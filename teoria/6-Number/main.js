...
// JS akceptuje różne systemy liczbowe (poza dziesiętnym)
...
//METODA .toExponential() - jawna zamiana na notację naukową (też jako string)
newNumber.toExponential()
//przy okazji pierwszeństwo działań warto zobaczyć
// typeof newNumber.toExponential() // pierwszenstwo ma wykonanie metody
...
const numberObj2 = new Number("coś") //podanie stringa da NaN, true da 1, a false 0
const umberObj3 = new Number("222.121") //da liczbę nawet jak podajemy argument jako string
const numberObj4 = new Number(222.121) //wynik taki sam co wyżej 
...
"20" * 1
    ...
    +
    "20"
// Natomiast liczbę na stringa możemy zamienić dodając pusty stri ng
20 + ""
