...
console.log(`Obecnie zegarek wskazuje ${new Date().toLocaleString()}`); //wlasciwosc obiektu Date toLocaleString wyswietli date zgodnie z ustawieniami systemu uzytkownika
