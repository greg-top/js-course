...
/* CZY ZMIENNA MA TYP? Czy zmienna jest typu string, number, itd?*/
...
// Obiekt globalny (window) z var tworzona jest nowa właściwość (głupie). Z let i const nie jest tworzona
