...
// Taki zakres nie istniał przed wprowadzneniem let i const (była tylko funkcja), wiec pojawił się w ES6
...

{
    ...
    // var var3 = "wewnętrzne 3" //ten element nadpisze zmienna globalna
    // console.log(var1);
    // console.log(var2);
    // console.log(var3);
    // var1 = "wewnętrzne 1";
    // var2 = "wewnętrzne 2"; //bd blad bo probujemy nadpisac zmienna lokalna const
    // var3 = "wewnętrzne 3";
    // const var4 = "coś"
}
// console.log(var1);
// console.log(var2);
// console.log(var3);
// console.log(var4); //bd blad, zmienna zostala stworzona w zakresie lokalnym i nie jest dostepna w zakresie globalnym
...
//     var c = "3 w bloku"; //nadpisze zakres globalny, var nie ma zakresu lokalnego w bloku
// }
...
// for (let i = 0; i < 10; i++) { //oddzielny zakres lokalny dla deklaracji let i
// let i = 10; //ten zakres wewnatrz bloku jest inny niz parametrow petli, dlatego moglismy zadeklarowac let i ponownie 
// console.log(i);
// const inFor = "wewnątrz pętli";
// if (i < 4) {
// i = 10;
// let i = 20;
//     inFor = "wewnątrz pętli i wewnątrz instrukcji warunkowej"; //bd blad, nie nadpiszemy bo w zakresie rodzica zmienna zadeklarowana jest jako CONST
...
// -- Po znaleznieniu (dopasowaniu) pierwszej pasującej zmiennej pozostałe nie są już szukane.