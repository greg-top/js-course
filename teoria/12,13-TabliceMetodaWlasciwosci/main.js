...
// Jeśli użyjemy minusa to mówimy ile od końca mamy zwrócić, w przykła dzie poniżej będzie tylko ostatni element
items.slice(-1);
...
// Ta metoda usuwa elementy z tablicy
const animals = ["dog", "cat", "canary", "mouse"];
// animals.splice(1, 2); //od indeksu pierwszego (czyli 2 element) usuń 2 elementy.
// animals.splice(2); //usunie wszystkie elementy od index 2, łącznie z nim element (usunie index-y, a więc zmniejszy długość tablicy)
...
"Gdańsk, Elbląg, Gdynia, Sopot, Władysławowo, Hel".split(', ', 3); //w ten sposob mozna wydzielic tablice gdzie elementy so rozdzielone przecinkiem i spacja
