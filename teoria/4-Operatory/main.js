...
2 * "2" // zwraca 4 (number), niejawna konwersja na number
...
// operator może być znakiem (znakami), może być słowem (zbudowany z liter) np. typeof, delete, new;
...
//OPERATOR WARUNKOWY (trójargumentowy) - Ternary operator
