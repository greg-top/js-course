...
// Tworzenie funkcji z pomocą fat arrow (funkcja)
...
//setInterval(() => console.log("minely 2 sekundy"), 2000); //krotszy zapis powyzszej funkcji z callbackiem zadeklarowanym jako argument funkcji wyzszego rzedu
...
// usersAge.forEach(function(user) { console.log("Wiek użytkownika to " + user); });
...
const showArguments = function () {
    ...
    console.log(Array.isArray(arguments)); //udowodnienie ze to nie jest tablica
}

// showArguments("5", null, {}) //test powyzszej funkcji
