...
// showMessage2("Wywolanie funkcji z parametrem");
...
const showMeTextMyArrowFunction2 = text => console.log(text); //przy jednym parametrze nie potrzebne sa nawiasy, gdy nie ma parametru lub 2+ to nawiasy musza byc

// showMeTextMyArrowFunction2("hejjjj222222!");
